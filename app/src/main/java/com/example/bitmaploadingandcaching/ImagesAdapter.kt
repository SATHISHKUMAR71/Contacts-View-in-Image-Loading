...
class ImagesAdapter(private var imageList:MutableList<String>,private var context: Context):RecyclerView.Adapter<ImagesAdapter.ImageHolder>(){
    private var i =0
...
//        shimmerFrameLayout.stopShimmer()
        ...
        holder.itemView.apply {
            Thread{
                val img = downloadImage(imageList[position])
                handler.post {
